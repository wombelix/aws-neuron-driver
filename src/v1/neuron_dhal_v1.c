 ...
 */
static int nr_initiate_reset_v1(struct neuron_device *nd)
{
	if (no_reset)
		return 0;
...
static int nr_initiate_reset_v1_qemu(struct neuron_device *nd)
{
	return 0;
}

static int nr_initiate_reset_v1_emu(struct neuron_device *nd)
{
